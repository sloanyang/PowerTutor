...
public class BatteryStats {
  ...
  private static final double[] VOLTAGE_CONV = { 1e-6, // Source in microvolts.
  ...
  private static final String[] TEMP_FILES = { "/sys/class/power_supply/battery/temp",
  ...
  private static final double[] CAPACITY_CONV = { 1e-2, // Source in percentage.
  };
