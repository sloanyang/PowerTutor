...
public class PhoneSelector {
  ...
  public static final int PHONE_CRESPO = 4; /* Samsung Nexus S */

  /* A hard-coded list of phones that have OLED screens. */
  public static final String[] OLED_PHONES = { "bravo", "passion", "GT-I9000", "inc", "legend", "GT-I7500", "SPH-M900",
      "SGH-I897", "SGH-T959", "desirec", };

  /*
   * This class is not supposed to be instantiated. Just use the static members.
   */
  ...
  public static int getPhoneType() {
    ...
    if (Build.DEVICE.startsWith("crespo"))
      return PHONE_CRESPO;
  ...
  public static PhoneConstants getConstants(Context context) {
    ...
    case PHONE_CRESPO:
      return new CrespoConstants(context);
    default:
