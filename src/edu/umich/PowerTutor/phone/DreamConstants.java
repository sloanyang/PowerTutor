...
public class DreamConstants implements PhoneConstants {
  ...
  /*
   * TODO: Figure out if this is really appropriate or how we should convert the
   * sensor power ratings (in mA) to mW. I'm not sure we'll try to model these
   * thing's power usage but for the developer it's definitely interesting to
   * get some (perhaps rough?) idea of how much power sensors are using.
   */
