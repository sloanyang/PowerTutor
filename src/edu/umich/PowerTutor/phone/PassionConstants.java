...
public class PassionConstants extends DreamConstants {
  ...
  public double lcdBacklight() {
    throw new RuntimeException("lcdBacklight() for passion which has no LCD " + "display");
  }
  ...
  private static final double[] arrayChannelPower = { 3.0647e-006, 4.4799e-006, 6.4045e-006 };
  ...
  private static final double[] arrayCpuPowerRatios = { 1.1273, 1.5907, 1.8736, 2.1745, 2.6031, 2.9612, 3.1373, 3.4513,
      3.9073, 4.1959, 4.6492, 5.4818 };

  public double[] cpuPowerRatios() {
    return arrayCpuPowerRatios;
  }

  private static final double[] arrayCpuFreqs = { 245, 384, 460, 499, 576, 614, 653, 691, 768, 806, 845, 998 };
